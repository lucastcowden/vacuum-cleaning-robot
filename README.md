For this project, I used Bayes Nets and policy/value iteration to allow an automated vacuum cleaning robot to determine what room it is in, as well as plot a series of actions that
